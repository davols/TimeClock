...
/**
 * Simple array adapter to list ClockIns. 
 * @author david
 *
 */
public class ClockListAdapter extends ArrayAdapter<ClockIn>{
	...
	public ClockListAdapter(Context context, int textViewResourceId,	ArrayList<ClockIn> objects,boolean uses24) {
